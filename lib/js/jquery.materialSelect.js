$.widget('dsabs.materialSelect', {
	options: {
		...
		templates: {
			...
			forceModificatorSelectPopup: $('<div style="display: none;"><form method="post" action="index.php"><label for="materialWeaponModificator"></label> <select id="materialWeaponModificator"></select><br /><input type="submit" value="Ok" /></form></div>')
		}
	},
	_create: function() {
		var self = this;
