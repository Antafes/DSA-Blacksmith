$.widget('dsabs.materialAsset', {
	options: {
		...
		fieldNames: {
			...
			hitPoints: 'hitPoints',
			armor: 'armor',
			forceModificator: 'forceModificator'
		},
		templates: {
			tableRow: $('<tr><td class="percentage"></td><td class="timeFactor"></td><td class="priceFactor"></td><td class="priceWeight"></td><td class="proof"></td><td class="breakFactor"></td><td class="hitPoints"></td><td class="armor"></td><td class="forceModificator"></td><td></td></tr>'),
			...
			forceModificatorField: $('<textarea></textarea>'),
	...
	_buildRow: function() {
		...
		this.options.templates.tableRow.children('.forceModificator').append(this.options.templates.forceModificatorField);
	...
	_addRow: function() {
		...
		row.children('.forceModificator').children(':input').attr('name', this.options.fieldNames.forceModificator + '[' + this._config.rowCount + ']');
